    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <!--<ul class="sidebar-menu">
                ...
                <li id="admin-index"><a href="${pageContext.request.contextPath}/main/main_Page.action"><i class="fa fa-dashboard"></i> <span>首页</span></a></li>  -->
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <a href="${pageContext.request.contextPath}/aca/toAddAcademy.action"> <button type="button" class="btn btn-default" title="新建">
...
<%--                        </div>--%>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc">学院编号</th>
                                <th class="sorting_desc">学院名称</th>
                                <th class="sorting_asc sorting_asc_disabled">学院人数</th>
                                <th class="sorting_desc sorting_desc_disabled">院长名字</th>
                                <th class="sorting">院长电话</th>
                                <th class="text-center">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                          <c:forEach items="${pageBean.list}" var="academy">
                            <tr>
                                <td><input name="ids" type="checkbox"></td>
                                <td>${academy.academyId}</td>
                                <td>${academy.academyName}</td>
                                <td>${academy.academyNumber}</td>
                                <td>${academy.deanName}</td>
                                <td>${academy.deanTel}</td>
                                <td class="text-center">
                                    <a href="${pageContext.request.contextPath}/aca/delteByOne.action?academyid=${academy.academyId}"> <button type="button"  class="btn bg-olive btn-xs">删除</button></a>
                                    <!--对应后端controller学院信息的删除的RequestMapping名字-->
                                    <a href="${pageContext.request.contextPath}/aca/updateByOne.action?academyid=${academy.academyId}"><button type="button" class="btn bg-olive btn-xs">编辑</button></a>
                                </td>
                            </tr>
</c:forEach>
                            </tbody>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <c:if test="${pageBean.currentPage !=1 }">
                                <li><a href="${pageContext.request.contextPath}/aca/academy_Page.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/aca/academy_Page.action?currentPage=${pageBean.currentPage-1 }">上一页</a></li>
                            </c:if>

                            <c:forEach begin="1" end="${pageBean.totalPage }" var="i">
                                <c:if test="${pageBean.currentPage == i }">
                                    <li><a href="${pageContext.request.contextPath}/aca/academy_Page.action?currentPage=${i}">${i }</a></li>
                                </c:if>
                                <c:if test="${pageBean.currentPage != i }">
                                    <li><a href="${pageContext.request.contextPath}/aca/academy_Page.action?currentPage=${i}">${i }</a></li>
                                </c:if>
                            ...
                            <c:if test="${pageBean.currentPage !=pageBean.totalPage }">
                                <li><a href="${pageContext.request.contextPath}/aca/academy_Page.action?currentPage=${pageBean.currentPage+1 }">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/aca/academy_Page.action?currentPage=${pageBean.totalPage }">尾页</a></li>
                            </c:if>
                        </ul>
                    </div>

                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <a href="${pageContext.request.contextPath}/clazz/toAddClazz.action"> <button type="button" class="btn btn-default" title="新建"><i class="fa fa-file-o"></i> 新建</button></a>
...
<%--                            </div>--%>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc">班级名称</th>
                                <th class="sorting_asc sorting_asc_disabled">班级人数</th>
                                <th class="sorting_desc sorting_desc_disabled">班主任名字</th>
                                <th class="sorting">班主任电话</th>
                                <th class="sorting_asc sorting_asc_disabled">班长名字</th>
                                <th class="sorting_desc sorting_desc_disabled">班长电话</th>
                                <th class="sorting">违纪率</th>
                                <th class="sorting_asc sorting_asc_disabled">挂科率</th>
                                <th class="sorting_desc sorting_desc_disabled">获奖率</th>
                                <th class="text-center">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <!--对应后台班级类的controller中的的查询所有班级信息的方法-->
                            <c:forEach items="${clazpageBean.list}" var="clazz">
                                <tr>
                                    <td><input name="ids" type="checkbox" value="${clazz.classId}"></td>
                                    <td>${clazz.className}</td>
                                    <td>${clazz.classNumber}</td>
                                    <td>${clazz.teacherName}</td>
                                    <td>${clazz.teacherTel}</td>
                                    <td>${clazz.monitorName}</td>
                                    <td>${clazz.monitorTel}</td>
                                    <td>${clazz.breakRuleRate}</td>
                                    <td>${clazz.failRate}</td>
                                    <td>${clazz.prizeRate}</td>

                                    <td class="text-center">
                                        <!--对应后端controller年级信息的删除的RequestMapping名字-->
                                        <a href="${pageContext.request.contextPath}/clazz/delteByOne.action?classid=${clazz.classId}"> <button type="button"  class="btn bg-olive btn-xs">删除</button></a>

                                        <a href="${pageContext.request.contextPath}/clazz/updateByOne.action?classid=${clazz.classId}"><button type="button" class="btn bg-olive btn-xs">编辑</button></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            第 ${clazpageBean.currentPage } / ${clazpageBean.totalPage }
                            &nbsp;&nbsp;
                            每页显示${clazpageBean.pageSize }条  &nbsp;&nbsp;&nbsp;
                            总计${clazpageBean.totalSize }条记录 &nbsp;&nbsp;&nbsp;
                        </div>
                    </div>

                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <c:if test="${clazpageBean.currentPage !=1 }">
                                <li><a href="${pageContext.request.contextPath}/clazz/clazz_Page.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/clazz/clazz_Page.action?currentPage=${clazpageBean.currentPage-1 }">上一页</a></li>
                            </c:if>

                            <c:forEach begin="1" end="${clazpageBean.totalPage }" var="i">
                                <c:if test="${clazpageBean.currentPage == i }">
                                    <li><a href="${pageContext.request.contextPath}/clazz/clazz_Page.action?currentPage=${i}">${i }</a></li>
                                </c:if>
                                <c:if test="${clazpageBean.currentPage != i }">
                                    <li><a href="${pageContext.request.contextPath}/clazz/clazz_Page.action?currentPage=${i}">${i }</a></li>
                                </c:if>
                            ...
                            <c:if test="${clazpageBean.currentPage !=clazpageBean.totalPage }">
                                <li><a href="${pageContext.request.contextPath}/clazz/clazz_Page.action?currentPage=${clazpageBean.currentPage+1 }">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/clazz/clazz_Page.action?currentPage=${clazpageBean.totalPage }">尾页</a></li>
                            </c:if>
                        </ul>
                    </div>

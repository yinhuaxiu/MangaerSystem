                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <a href="${pageContext.request.contextPath}/stu/addStudent_Page.action"> <button type="button" class="btn btn-default" title="新建"><i class="fa fa-file-o"></i> 新建</button></a>
                                    <!--对应学生信息的增加-->
                                </div>
                            </div>
                        </div>
...
<%--                                <!--按学号/名字进行搜索班级信息    根据后端开发员的方法书写-->--%>
<%--                                <span class="glyphicon glyphicon-search form-control-feedback"></span>--%>
<%--                            </div>--%>
<%--                        </div>--%>
                        <!--工具栏/-->
                        <form action="${pageContext.request.contextPath}/stu/deleteall.action" method="post">

                        <!--数据列表-->
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            <thead>
                            <tr><input style="margin-left: 8px;" type="submit" value="批量删除" class="btn btn-default"></tr>
                            <tr>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">班级名称</th>
                                <th class="sorting_desc sorting_desc_disabled">性别</th>
                                <th class="sorting">年龄</th>
                                <th class="sorting_asc sorting_asc_disabled">照片</th>
                                <th class="sorting_desc sorting_desc_disabled">医保卡记录情况</th>
                                <th class="sorting_desc sorting_desc_disabled">学院</th>
                                <th class="text-center">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${stupageBean.list}" var="student">
                                <tr>
                                    <td><input name="ids" type="checkbox" value="${student.studentId}"></td>
                                    ...
                                    <td>
                                        ...
                                        <img src="/uploads/${student.photo}" width="50" height="50">
                                        </c:if>
                                    </td>
                                    <td>${student.remark}</td></a>
                                    <td>${student.academyName}</td>

                                    <td class="text-center">
                                        <!--对应后端controller信息的删除的RequestMapping名字-->
                                        <a href="${pageContext.request.contextPath}/stu/delteByOne.action?studentId=${student.studentId}"> <button type="button"  class="btn bg-olive btn-xs">删除</button></a>

                                        <a href="${pageContext.request.contextPath}/stu/updateByOne.action?studentId=${student.studentId}"> <button type="button" class="btn bg-olive btn-xs">编辑</button></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            第 ${stupageBean.currentPage } / ${stupageBean.totalPage }
                            &nbsp;&nbsp;
                            每页显示${stupageBean.pageSize }条  &nbsp;&nbsp;&nbsp;
                            总计${stupageBean.totalSize }条记录 &nbsp;&nbsp;&nbsp;
                        </div>
                    </div>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <c:if test="${stupageBean.currentPage !=1 }">
                                <li><a href="${pageContext.request.contextPath}/stu/student_Page.action?currentPage=1">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/stu/student_Page.action?currentPage=${pageBean.currentPage-1 }">上一页</a></li>
                            </c:if>

                            <c:forEach begin="1" end="${stupageBean.totalPage }" var="i">
                                <c:if test="${stupageBean.currentPage == i }">
                                    <li><a href="${pageContext.request.contextPath}/stu/student_Page.action?currentPage=${i}">${i }</a></li>
                                </c:if>
                                <c:if test="${stupageBean.currentPage != i }">
                                    <li><a href="${pageContext.request.contextPath}/stu/student_Page.action?currentPage=${i}">${i }</a></li>
                                </c:if>
                            ...
                            <c:if test="${stupageBean.currentPage !=stupageBean.totalPage }">
                                <li><a href="${pageContext.request.contextPath}/stu/student_Page.action?currentPage=${stupageBean.currentPage+1 }">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/stu/student_Page.action?currentPage=${stupageBean.totalPage }">尾页</a></li>
                            </c:if>
                        </ul>
                        </ul>
                    </div>

    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <table border=1  align="center" bgcolor="#ecf0f5" width="850" height="300">
                ...
                <form action="${pageContext.request.contextPath}/aca/addAcademy.action" mythod="post" id="addAcademyform" name="reg">
                    <tr style="border: none;"><td style="border: none;" align="center" width="850" colspan="6"><font face="宋体" color="dimgrey" size="6"><b>添加学院信息</b></td></tr>
                    <tr>
                        ...
                        <td align="center"><input type="text" name="academyName" maxlength="20"
                                                  style="height: 25px;width: 300px; border: none;" value="${academy.academyName}"></td>
                        <td align="center" width="100"><font face="宋体" color="black" size="4">学院人数:</td>
                        <td align="center"><input type="text" name="academyNumber" maxlength="20"
                                                  style="height: 25px;width: 300px; border: none;" value="${academy.academyNumber}"></td></tr>
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="text" name="deanName" maxlength="20"
                                                  style="height: 25px;width: 300px; border: none;" value="${academy.deanName}"></td>
                        <td align="center" width="100"><font face="宋体" color="black" size="4">院校号码:</td>
                        <td align="center"><input type="text" name="deanTel" maxlength="20"
                                                  style="height: 25px;width: 300px; border: none;" value="${academy.deanTel}"></td></tr>
                    ...
                    <tr style="border:none;"><td align="center" colspan="6" style="height:35px;border:none;">
                        ...
                        <!--保存之后后台根据controller进行对数据的存储并进行重定向查询所有的学院信息页面-->   
...
<script>
    ...
    function submitAcademyform(){
        //获取form表单对象并提交
        var form=document.getElementById("addAcademyform");
        form.onsubmit();//提交表单
    }

...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <table border=1  align="center" bgcolor="#ecf0f5" width="850" height="400">
            ...
            <form action="${pageContext.request.contextPath}/clazz/addClazz.action" mythod="post" id="addClassform" name="reg">
                <tr style="border: none;"><td style="border: none;" align="center" width="850" colspan="6"><font face="宋体" color="dimgrey" size="6"><b>添加班级信息</b></td></tr>
                <tr>
                    <td align="center" width="120">
                        <font face="宋体" color="black" size="4">班级名称:</font>
                    </td>
                    <td align="center">
                        <input class="wirte" type="text" name="className" value="${clazz.className}" simaxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                    <td align="center" width="120">
                        <font face="宋体" color="black" size="4">班级人数:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="classNumber" value="${clazz.classNumber}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                </tr>

                <tr>
                    <td align="center" width="120">
                        <font face="宋体" color="black" size="4">班主任名字:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="teacherName" value="${clazz.teacherName}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                    <td align="center" width="120">
                        <font face="宋体" color="black" size="4">班主任电话:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="teacherTel" value="${clazz.teacherTel}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                </tr>

                <tr>
                    <td align="center" width="120">
                        <font face="宋体" color="black" size="4">班长名字:
                    </td>
                    <td align="center">
                        <input type="text" name="monitorName" value="${clazz.monitorName}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                    <td align="center" width="120">
                        <font face="宋体" color="black" size="4">班长电话:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="monitorTel" value="${clazz.monitorTel}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center" width="120">
                        <font face="宋体" color="black" size="4">违纪率:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="breakRuleRate" value="${clazz.breakRuleRate}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                    <td align="center" width="120">
                        <font face="宋体" color="black" size="4">挂科率:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="failRate" value="${clazz.failRate}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                </tr>

                <tr>
                    <td align="center" width="120">
                        <font face="宋体" color="black" size="4">获奖率:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="prizeRate" value="${clazz.prizeRate}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                   </tr>

                <tr style="border:none;"><td align="center" colspan="6" style="height:35px;border:none;">
                    <input style="height:25px;width:60px;border: 0.025rem;font-weight: bold;" type="submit" value="保存" name="yes" >   
                    <!--在后台进行重定向查询所有的班级信息页面-->   
                    <input style="height:25px;width:60px;border: 0.025rem;font-weight: bold;" type="reset" value="重置" name="reset"></td></tr>
            </form>
        </table>

    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <table border=1  align="center" bgcolor="#ecf0f5" width="850" height="300">
                ...
                <form action="${pageContext.request.contextPath}/grade/addGrade.action" mythod="post" id="addGradeform" name="reg">
                    <tr style="border: none;"><td style="border: none;" align="center" width="850" colspan="6"><font face="宋体" color="dimgrey" size="6"><b>添加年级信息</b></td></tr>
                    <tr>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">年级名称:</font>
                        </td>
                        <td align="center">
                            <input class="wirte" type="text" name="gradeName" value="${grade.gradeName}" simaxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">年级人数:</font>
                        </td>
                        <td align="center">
                            <input type="text" name="gradeNumber" value="${grade.gradeNumber}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                    </tr>

                    <tr>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">年级就业率:</font>
                        </td>
                        <td align="center">
                            <input type="text" name="employmengtRate" value="${grade.employmentRate}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">年级考研率:</font>
                        </td>
                        <td align="center">
                            <input type="text" name="postgradeRate" value="${grade.postgradeRate}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                    </tr>
                    ...
                    <tr style="border:none;"><td align="center" colspan="6" style="height:35px;border:none;">
                        ...
                        <!--保存之后后台根据controller进行对数据的存储并进行重定向查询所有的年级信息页面-->   

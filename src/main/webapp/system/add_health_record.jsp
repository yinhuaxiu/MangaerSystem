    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <table border=1  align="center" bgcolor="#ecf0f5" width="850" height="300">
                ...
                <form action="${pageContext.request.contextPath}/health/addHealyCardRecord.action" method="post" id="addHealthform" name="reg">
                    ...
                    <tr>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">编号:</font>
                        </td>
                        <td align="center">
                            <input class="wirte" type="text" name="remarkNum" value="${healthCardRecord.remarkNum}" simaxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">姓名:</font>
                        </td>
                        <td align="center">
                            <input type="text" name="studentName" value="${healthCardRecord.studentName}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <input type="text" name="sex" value="${healthCardRecord.sex}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">时间:</font>
                        </td>
                        <td align="center">
                            <input type="text" name="stime" value="${healthCardRecord.stime}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                    </tr>

                    <tr>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">地点:</font>
                        </td>
                        <td align="center">
                            <input type="text" name="address" value="${healthCardRecord.address}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">药品名:</font>
                        </td>
                        <td align="center">
                            <input type="text" name="medicineName" value="${healthCardRecord.medicineName}"maxlength="20" style="height: 25px;width: 300px; border: none;">
                        </td>
                    </tr>

                    <tr>
                        <td align="center" width="100">
                            <font face="宋体" color="black" size="4">是否需转至医院:</font>
                        </td>
                        <td align="center">
                            <input type="text" name="ismoveToHosp" value="${healthCardRecord.ismoveToHosp}" maxlength="20" placeholder="如需请填1反之则为0" style="height: 25px;width: 300px; border: none;">
                        </td>
                        <td align="center" width="100">
                    ...
                    <tr style="border:none;"><td align="center" colspan="6" style="height:35px;border:none;">
                        <input style="height:25px;width:60px;border: 0.025rem;font-weight: bold;" type="submit" value="保存">   
                        <!--保存之后后台根据controller进行对数据的存储并进行重定向查询所有的医保卡信息页面-->   
...
<script>
    ...
    function submitHealthform(){
        //获取form表单对象并提交
        var form=document.getElementById("addHealthform");
        form.onsubmit();//提交表单
    }

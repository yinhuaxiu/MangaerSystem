...
<body class="hold-transition login-page" onload="check()">
<div class="login-box">
...
<%--        <a href="#">忘记密码</a><br>--%>
        <a href="${pageContext.request.contextPath}/Login/register_Page.action" class="text-center">新用户注册</a>

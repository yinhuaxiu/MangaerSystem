...
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        <form action="${pageContext.request.contextPath}/Login/register.action" method="get">
       ...
       <!--<div class="social-auth-links text-center">
        ...
        <a href="${pageContext.request.contextPath}/Login/login_Page.action" class="text-center">我有账号，现在就去登录</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->

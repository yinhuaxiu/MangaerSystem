    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <table border=1  align="center" bgcolor="#ecf0f5" width="850" height="300">
                ...
                <form action="${pageContext.request.contextPath}/health/updateInfoByHealthId.action" method="post" id="addHealthform" name="reg">
                    <tr>
                        <input type="hidden" name="id" value="${healthCardRecord.id}">
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <input type="text" name="ismoveToHosp" value="${healthCardRecord.ismoveToHosp}" maxlength="20" placeholder="如需请填是反之则为否" style="height: 25px;width: 300px; border: none;">
                        </td>
                        <td align="center" width="100">
                    ...
                    <tr style="border:none;"><td align="center" colspan="6" style="height:35px;border:none;">
                        ...
                        <input style="height:30px;width:80px;border: 0.025rem;font-weight: bold;text-align: center;background-color:#ddd;"
                               type="button" onclick="location.href='${pageContext.request.contextPath}/health/healthcardrecord_Page.action?currentPage=1'"

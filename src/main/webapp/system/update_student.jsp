...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <table border=1  align="center" bgcolor="#ecf0f5" width="850" height="400">
            ...
            <form action="${pageContext.request.contextPath}/stu/updateInfoByStudentd.action" method="post" id="addStudentform" name="reg" enctype="multipart/form-data">
                <tr style="border: none;">
                    <td style="border: none;" align="center" width="850" colspan="6">
                        <font face="宋体" color="dimgrey" size="6">
                            <b>修改学生信息</b>
                        </font>
                    </td>
                </tr>
                <tr>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4">学号:</font>
                    </td>
                    <td align="center">
                        <input class="wirte" type="text" name="studentNum" value="${student.studentNum}" simaxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4">姓名:</font>
                    </td>
                    <td align="center"><input type="text" name="studentName" value="${student.studentName}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                </tr>

                <tr>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4">班级:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="className" value="${student.className}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4">性别:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="sex" value="${student.sex}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4">年龄:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="age" value="${student.age}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4">照片:</font>
                    </td>
                    <td align="center">
                        <input type="file" name="picture"  maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4">医保卡编号:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="remark" value="${student.remark}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4">学院:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="academyName" value="${student.academyName}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                </tr>
                <tr>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4">学生编号:</font>
                    </td>
                    <td align="center">
                        <input type="text" name="studentId" value="${student.studentId}" maxlength="20" style="height: 25px;width: 300px; border: none;">
                    </td>
                    <td align="center" width="100">
                        <font face="宋体" color="black" size="4"></font>
                    </td>
                    <td align="center"></td>
                </tr>
                ...
                <tr style="border:none;height:60px;"><td align="center" colspan="6" style="height:35px;border:none;">
                    ...
                    <input style="height:30px;width:80px;border: 0.025rem;font-weight: bold;text-align: center;background-color:#ddd;"
                           type="button" onclick="location.href='${pageContext. request. contextPath}/stu/student_Page.action?currentPage=1'"
